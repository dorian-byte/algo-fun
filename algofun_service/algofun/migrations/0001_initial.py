# Generated by Django 4.0.3 on 2023-10-02 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(db_index=True, max_length=100, unique=True)),
                ('url', models.URLField(blank=True, null=True)),
                ('resource_type', models.CharField(blank=True, choices=[('image', 'image'), ('video', 'video'), ('article', 'article'), ('solution_post', 'solution post')], default='solution_post', max_length=100, null=True)),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
            ],
            options={
                'abstract': False,
